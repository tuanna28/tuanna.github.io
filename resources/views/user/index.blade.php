...
@include('product.header')
        ...
        <div class="category">
            ...
            <div class="action">
                ...
                <form action="users.php" method="POSTPOST">
                    <input type="text" name="findname" placeholder="Search name users">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('user.destroy',$user->id) }}" method="Post">
                                <a class="btn btn-productimary" href="{{ route('user.edit',$user->id) }}">Edit</a>
                                @csrf
                                @method('DELETE')
