            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="radio"   name="typeuser" class="form-control" placeholder="User TypeUser">Admin
                        <input type="radio"  name="typeuser" class="form-control" placeholder="User TypeUser"> Client
                        @error('typeuser')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
