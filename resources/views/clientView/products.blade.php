                    ...
                    <div class="product-grid" data-isotope='{ "itemSelector": ".product-item", "layoutMode": "fitRows" }'>
                        ...
                        <div class="product-item men">
                            <div class="product discount product_filter">
                                ...
                                <a href="{{route('clientView.detail-products,$product->id')}}">        <img src="{{asset('storage/images/'.$product->image)}}" alt=""> </a>
                                </div>
                                <div class="favorite favorite_left"></div>
                                <div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>-$20</span></div>
                                <div class="product_info">
                                    <h6 class="product_name"><a href="{{route('clientView.detail-products,$product->id')}}">{{$product->name}}></a></h6>
                                    <div class="product_price"><a href="{{route('clientView.detail-products,$product->id')}}">{{$product->price}}</a>VND<span></span></div>
                                </div>
                            </div>
